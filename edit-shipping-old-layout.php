									...
									<form method="POST" action="">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <label for="formGroupExampleInput">Email *</label>
                                                <input type="email" class="form-control" name="consignor_email" value="<?php echo $shipping['consignor_email']; ?>" required placeholder="Email">
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <label for="formGroupExampleInput">Address *</label>
                                                <input type="text" class="form-control" name="consignor_address" value="<?php echo $shipping['consignor_address']; ?>" required placeholder="Address">
                                            </div>
										</div>
                                        <div class="row mb-4">
                                            <div class="col">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col">
                                            <label for="formGroupExampleInput">Email *</label>
                                                <input type="email" class="form-control" name="consignee_email" placeholder="Email" value="<?php echo $shipping['consignee_email']; ?>" required>
                                            </div>
                                            <div class="col">
                                            <label for="formGroupExampleInput">Phone *</label>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col">
                                            <label for="formGroupExampleInput">Address *</label>
                                                <input type="text" class="form-control" name="consignee_address" value="<?php echo $shipping['consignee_address']; ?>" required placeholder="Address">
                                            </div>
										</div>
                                        <div class="row mb-4">
                                            <div class="col">
