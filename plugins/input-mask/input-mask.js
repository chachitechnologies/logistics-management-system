$(document).ready(function(){
    ...
    $('#static-mask-pan').inputmask({mask: "aaaaa9999a"});  //static mask
    $('#static-mask-aadhar').inputmask("999999999999");  //static mask
    $('#static-mask-gst').inputmask({mask: "99aaaaa9999a9a9"});  //static mask
    $('#static-mask-iec').inputmask({mask: "aaaaa9999a"});  //static mask
