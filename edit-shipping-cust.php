...
if (empty($_SESSION['session'])) {  
	...
	$shipping = $db->query("SELECT * FROM shipping WHERE `id` = '{$_GET['id']}' and `user_id` = '{$_SESSION['master_id']}' and status = 1")->fetch();
		...
		$stmt->bindParam(':mid', $_SESSION['master_id'], PDO::PARAM_INT);	
			if ($stmt->execute()) {
				//$successMSG = "Lead has been successfully updated.";
				header("Location: edit-shipping-cust.php?id=" . $_GET['id']);
			} else {
							...
							<div class="row">
								...
								<?php
									...
									<form method="POST" action="">
                                        ...
                                        <div class="row mb-4">
											<input type="hidden" name="shipping_status" value="<?php echo $shipping['shipping_status']; ?>">
                                            <div class="col">
											...
											<input type="hidden" name="forwarding" value="<?php echo $shipping['forwarding']; ?>">
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <input type="hidden" name="base_rate" value="<?php echo $shipping['base_rate']; ?>">
                                            <input type="hidden" name="fuel_rate" value="<?php echo $shipping['fuel_rate']; ?>">
                                            <input type="hidden" name="extra_charge" value="<?php echo $shipping['extra_charge']; ?>">
                                            <input type="hidden" name="gst_rate" value="<?php echo $shipping['gst_rate']; ?>">
                                            <input type="hidden" name="total_charge" value="<?php echo $shipping['total_charge']; ?>">
										<hr>
										<h5>Remarks</h5>
                                        <div class="row mb-4">
                                            <div class="col">
