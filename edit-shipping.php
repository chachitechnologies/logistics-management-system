	...
	$shipping = $db->query("SELECT * FROM shipping WHERE `id` = '{$_GET['id']}' and status = 1")->fetch();
		...
		$stmt->bindParam(':d', $_POST['id'], PDO::PARAM_INT);	
			if ($stmt->execute()) {
				...
				header("Location: edit-shipping.php?id=" . $_GET['id']);
			} else {
                                ...
                                <div class="col-lg-12 col-12 mx-auto">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <label for="formGroupExampleInput">Status</label>
												<select name="shipping_status" class="selectpicker form-control" required>
                                            ...
                                            <label for="formGroupExampleInput">Booking Date *</label>
                                                <input type="date" class="form-control" name="b_date" placeholder="Booking Date" value="<?php echo $shipping['b_date']; ?>" required <?php if ($_SESSION['type'] == 'ADM') {}else{echo 'readonly';}?>>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="col-lg-12 col-12 mx-auto">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <label for="formGroupExampleInput">CPerson</label>
                                                <input type="text" class="form-control" name="consignor_cperson" value="<?php echo $shipping['consignor_cperson']; ?>" placeholder="CPerson">
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            ...
                                            <label for="formGroupExampleInput">Phone *</label>
                                                <input type="text" class="form-control" name="consignor_phone" value="<?php echo $shipping['consignor_phone']; ?>" required placeholder="Phone">
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                            <label for="formGroupExampleInput">Address *</label>
                                                <textarea class="form-control" name="consignor_address" required placeholder="Address"><?php echo $shipping['consignor_address']; ?></textarea>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            ...
                                            <label for="formGroupExampleInput">State</label>
                                                <input type="text" class="form-control" name="consignor_state" placeholder="State" value="<?php echo $shipping['consignor_state']; ?>">
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">City</label>
                                                <input type="text" class="form-control" name="consignor_city" placeholder="City" value="<?php echo $shipping['consignor_city']; ?>">
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">Zip</label>
                                                <input type="text" class="form-control" name="consignor_zip" placeholder="Zip" value="<?php echo $shipping['consignor_zip']; ?>">
                                            </div>
									
                                            <div class="col-lg-6">
                                            <label for="formGroupExampleInput">Select ID Proof *</label>												
												<select name="consignor_doc_type" class="selectpicker form-control" required>
													<option>Choose...</option>
							...
							<div class="row">
                                <div class="col-lg-12 col-12 mx-auto">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">CPerson</label>
                                                <input type="text" class="form-control" name="consignee_cperson" placeholder="CPerson" value="<?php echo $shipping['consignee_cperson']; ?>">
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">Email</label>
                                            ...
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">Phone *</label>
                                                <input type="text" class="form-control" name="consignee_phone" placeholder="Phone" value="<?php echo $shipping['consignee_phone']; ?>" required>
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                            <label for="formGroupExampleInput">Address *</label>
                                                <textarea class="form-control" name="consignee_address" required placeholder="Address"><?php echo $shipping['consignee_address']; ?></textarea>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">Country *</label>
                                            ...
                                            <div class="col-lg-6 mb-2">
                                            <label for="formGroupExampleInput">State</label>
                                                <input type="text" class="form-control" name="consignee_state" placeholder="State" value="<?php echo $shipping['consignee_state']; ?>">
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                            <label for="formGroupExampleInput">City</label>
                                                <input type="text" class="form-control" name="consignee_city" placeholder="City" value="<?php echo $shipping['consignee_city']; ?>">
                                            </div>
                                            <div class="col-lg-12">
                                            <label for="formGroupExampleInput">Zip</label>
                                                <input type="text" class="form-control" name="consignee_zip" placeholder="Zip" value="<?php echo $shipping['consignee_zip']; ?>">
                                            </div>
                                        </div>
                                </div>
                            </div>
